...
import 'package:tada/ui/components/buttons/settings_button.dart';
import 'package:tada/ui/components/time/time_select_tile.dart';
    ...
    if (_hasUnsavedChanges()) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text('You have unsaved changes in your timer settings. Would you like to save them?'),
          actions: [
            FButton(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: dark ? EColors.darkerGrey : EColors.lightGrey,
              ...
              child: Row(
                ...
                children: [
                  const Text('Pomodoro Mode', style: TextStyle(fontSize: 16)),
                  Switch(
                    value: _pomodoroMode,
                    onChanged: (value) => setState(() => _pomodoroMode = value),
                  ),
                ],
              ),
            ),
            ...
            Opacity(
              ...
              child: TimeSelectTile(
                ...
                onChanged: _pomodoroMode ? (value) => setState(() => _focusTime = value) : (value) {},
            ...
            Opacity(
              ...
              child: TimeSelectTile(
                ...
                onChanged: _pomodoroMode ? (value) => setState(() => _breakTime = value) : (value) {},
                icon: Iconsax.coffee,
              ),
            ),
            const SizedBox(height: 8),
            Opacity(
              ...
              child: TimeSelectTile(
                ...
                onChanged: _pomodoroMode ? (value) => setState(() => _longBreakTime = value) : (value) {},
                icon: Iconsax.cup,
              ),
            ),
