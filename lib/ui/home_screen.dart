...
import 'package:forui/forui.dart' show FButton, FButtonStyle, FSelectMenuTile, FSelectTile, FRadioSelectGroupController, FPortalFollowerShift, FHidePopoverRegion, FDialog;
...
import 'package:tada/ui/components/flow_timer/flow_timer.dart';
import 'package:tada/ui/pages/timer_settings_page.dart';
import 'package:tada/utils/constants/colors.dart';
import 'package:tada/utils/constants/sizes.dart';
import 'package:shadcn_ui/shadcn_ui.dart';
import 'package:tada/ui/components/timer/timer_style.dart';
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: dark ? EColors.darkerGrey : Theme.of(context).colorScheme.surfaceContainerHigh.withOpacity(0.5),
        ...
        if (isMenuOpen)
          Container(
            ...
            child: Column(
              children: widget.options.map((option) => GestureDetector(
                onTap: () {
                  setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: HeaderAppbar(
        ...
        actions: [
          IconButton(
            onPressed: () => Get.to(() => TimerSettingsPage(
              pomodoroMode: _pomodoroMode,
              focusTime: _focusTime,
              breakTime: _breakTime,
              longBreakTime: _longBreakTime,
              currentStyle: _currentStyle,
              onPomodoroModeChanged: (value) => setState(() => _pomodoroMode = value),
              onFocusTimeChanged: (value) => _updateTimerSettings(value, _breakTime, _longBreakTime),
              onBreakTimeChanged: (value) => _updateTimerSettings(_focusTime, value, _longBreakTime),
              onLongBreakTimeChanged: (value) => _updateTimerSettings(_focusTime, _breakTime, value),
